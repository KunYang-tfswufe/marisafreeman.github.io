...
yay -S envycontrol    # https://github.com/bayasdev/envycontrol or yay -S optimus-manager-git https://github.com/Askannz/optimus-manager
...
matches:
  ...
  - trigger: "`7"
    replace: |-
      请教我且从电脑开机开始,逐步教我这个项目的开发(采用快速原型开发)先搭建基本的骨架实现最基础的功能,我使用arch linux.
  ...
  - trigger: "`t"
    replace: |-
      以下是项目的每个源文件,每个文件我用注释分开,请帮我分析整个项目:#main.py 文件内容  #head.py  文件内容
